...
;; Guix built-in, but without version in name. We just prey they will never be updated.
(define-public node-inherits-2.0.4 node-inherits)
(define-public node-util-deprecate-1.0.2 node-util-deprecate)
(define-public node-safe-buffer-5.2.1 node-safe-buffer)
(define-public node-color-name-1.1.3 node-color-name)
(define-public node-once-1.4.0 node-once)
(define-public node-wrappy-1.0.2 node-wrappy)
(define-public node-ms-2.1.3 node-ms)
(define-public node-bindings-1.5.0 node-bindings)
(define-public node-string-decoder-1.3.0 node-string-decoder)
  ...
  (package
    ...
    (inputs `(("node-node-addon-api" ,node-node-addon-api-3.2.1)
       ...
       ("prebuilt"
        ,(origin
           (method url-fetch)
           (uri "https://github.com/yanyiwu/nodejieba/releases/download/v2.5.2/nodejieba-v2.5.2-node-v88-linux-x64.tar.gz")
           (sha256
            (base32
...
(define-public node-prosemirror-view-1.31.4
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri
               "https://registry.npmjs.org/prosemirror-view/-/prosemirror-view-1.31.4.tgz")
              (sha256
               (base32
                "10idr6z8ldr2qc800ilsx0fwv2bn207hx0f0f82g43i9ixr4xmln"))))
    (build-system node-build-system)
    (arguments
     '(#:tests? #f
       #:modules
                  ...
                  (add-after 'patch-dependencies 'delete-dev-dependencies
                    (lambda _
                      (delete-dependencies '("@prosemirror/buildhelper"
                                             ...
                                             "prosemirror-view")))))))
    (inputs `(;("node-prosemirror-view" ,node-prosemirror-view-1.31.4)
...
(define-public node-prosemirror-dev-tools-2.1.1
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri
               "https://registry.npmjs.org/prosemirror-dev-tools/-/prosemirror-dev-tools-2.1.1.tgz")
              (sha256
               (base32
    ...
    (arguments
     '(#:tests? #f
       #:phases (modify-phases %standard-phases
                  ...
                  (add-after 'patch-dependencies 'delete-dev-dependencies
                    (lambda _
                      (delete-dependencies '("aik" "babel-cli"
                                             "babel-core"
                                             "babel-loader"
                                             "babel-plugin-syntax-class-properties"
                                             "babel-plugin-transform-class-properties"
    ...
    (inputs `(("node-unstated" ,node-unstated-2.1.1)
              ...
              ("node-ie-array-find-polyfill" ,node-ie-array-find-polyfill-1.1.0)
              ("node-html" ,node-html-1.0.0)
              ("node-es6-object-assign" ,node-es6-object-assign-1.1.0)
              ("node-emotion" ,node-emotion-9.2.12)
       ...
       #:phases (modify-phases %standard-phases
                  ...
                  (add-after 'patch-dependencies 'delete-dev-dependencies
                    (lambda _
                      (delete-dependencies '("@prosemirror/buildhelper")))))))
    (inputs `(("node-prosemirror-transform" ,node-prosemirror-transform-1.7.3)
              ("node-prosemirror-view" ,node-prosemirror-view-1.31.4)
              ("node-prosemirror-state" ,node-prosemirror-state-1.4.3)))
...
(define-public node-prosemirror-tables-0.9.5
  (package
    (name "node-prosemirror-tables")
    (version "0.9.5")
    (source (origin
              (method url-fetch)
              (uri
               "https://registry.npmjs.org/prosemirror-tables/-/prosemirror-tables-0.9.5.tgz")
              (sha256
               (base32
                "0nh4jc4yk67znnnv50i3rj9mf7fiv9g8isjnss7a2hxkgkvidrss"))))
    (build-system node-build-system)
    (arguments
     '(#:tests? #f
       #:phases (modify-phases %standard-phases
                  ...
                  (add-after 'patch-dependencies 'delete-dev-dependencies
                    (lambda _
                      (delete-dependencies '("@types/prosemirror-model"
...
(define-public node-react-17.0.2
  (package
    (name "node-react")
    (version "17.0.2")
    (source (origin
              (method url-fetch)
              (uri "https://registry.npmjs.org/react/-/react-17.0.2.tgz")
              (sha256
               (base32
                "0vf6dmm139yjjnrdpx3fnsknbbgyr9xzrlajz6z6k96mgxvir472"))))
    (build-system node-build-system)
    (arguments
     '(#:tests? #f
       #:phases (modify-phases %standard-phases
...
(define-public node-react-dom-17.0.2
  (package
    (name "node-react-dom")
    (version "17.0.2")
    (source (origin
              ...
              (sha256
               (base32
                "165ssvkqf443rfqjd8c7hj5fb9y5z99mn8q1prpyf994dh3lvimy"))))
    (build-system node-build-system)
    (arguments
     '(#:tests? #f
       #:phases (modify-phases %standard-phases
                  ...
                  (add-after 'patch-dependencies 'delete-dev-dependencies
                    (lambda _
                      (delete-dependencies '("react")))))))
    (inputs `(("node-scheduler" ,node-scheduler-0.20.2)
              ("node-object-assign" ,node-object-assign-4.1.1)
              ("node-loose-envify" ,node-loose-envify-1.4.0)
              ("node-react" ,node-react-17.0.2)))
    (home-page "https://reactjs.org/")
    (synopsis "React package for working with the DOM.")
    (description "React package for working with the DOM.")
    (license license:expat)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "10krd3s0fzglwvk0khb4px82amjmf30qalv789i3vbfvln26ar3y"))))
    (arguments
                  ...
                  (add-after 'unpack 'add-deps
                    (lambda _
                      (with-atomic-json-file-replacement "package.json"
                        (match-lambda
                          (('@ . pkg-meta-alist)
                           (cons '@ (cons '("dependencies" @ ("inspector-gadget" . "^1.0.0"))
                                         pkg-meta-alist)))))))
                  (add-after 'patch-dependencies 'delete-dev-dependencies
                    (lambda _
                      (delete-dependencies '("ava" "babel-cli"
